...
<html>
<head>
    <title>SISTEM INFORMASI SMART LAUNDRY</title>
    ...
    <div class="container">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            while($t=mysqli_fetch_array($transaksi)){
                ?>
                <center><h2>SMART LAUNDRY</h2></center>
                <h3></h3>
                ...
                <table class="table">
                    <tr>
                        ...
                        <th>:</th>
                        <td>001-<?php echo $t['transaksi_id']; ?></td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <br/>
                    <p><center><i>"SALAM BERSIH, SALAM WANGI, SALAM SATU CUCIAN"</i></center></p>
                    <?php
                }
                ?>
            </div>
