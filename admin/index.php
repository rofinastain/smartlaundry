...
<div class="container">
    <div class="alert alert-info text-center">
        <h4 style="margin-bottom: 0px">SELAMAT DATANG DI <b>SMART LAUNDRY</b></h4>
    </div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <?php
                $data = mysqli_query($koneksi,"select * from pelanggan,transaksi where transaksi_pelanggan=pelanggan_id order by transaksi_id desc limit 25");
                $no = 1;
                while($d=mysqli_fetch_array($data)){
                    ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td>001-<?php echo $d['transaksi_id']; ?></td>
